...
for count, i in enumerate(iterations):
    ...
    #For time CASE 2
    Case3_GA_NPV_STD[count] = data.iloc[3][f'{i}']
    Case3_GA_LCOS_STD[count] = data.iloc[7][f'{i}']
    Case3_FF_NPV_STD[count] = data.iloc[11][f'{i}']
    Case3_FF_LCOS_STD[count] = data.iloc[15][f'{i}']

    #For time Case 3
    Case3_GA_NPV_STD[count] = data.iloc[20][f'{i}']
    Case3_GA_LCOS_STD[count] = data.iloc[25][f'{i}']
    Case3_FF_NPV_STD[count] = data.iloc[30][f'{i}']
    Case3_FF_LCOS_STD[count] = data.iloc[35][f'{i}']

    #For time STD CASE 2
    Case3_GA_NPV_STD[count] = data.iloc[44][f'{i}']
    Case3_GA_LCOS_STD[count] = data.iloc[45][f'{i}']
    Case3_FF_NPV_STD[count] = data.iloc[46][f'{i}']
    Case3_FF_LCOS_STD[count] = data.iloc[47][f'{i}']

    #For time STD Case 3
    Case3_GA_NPV_STD[count] = data.iloc[48][f'{i}']
    Case3_GA_LCOS_STD[count] = data.iloc[49][f'{i}']
    Case3_FF_NPV_STD[count] = data.iloc[50][f'{i}']
    Case3_FF_LCOS_STD[count] = data.iloc[51][f'{i}']

...
def ESS_schedule(ESS_capacity_size, ESS_power,
    ...
    #I have not included the energy hourly use as then I have to move it to outside the schedule funciton in order to correctly calculate
    #the peak demand charge cost, and as written before this is hard to assume that the usage would go down or up.

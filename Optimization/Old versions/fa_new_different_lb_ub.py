...
class fa(intelligence.sw):
    ...
    def __init__(self, n, function, lb1, ub1, lb2, ub2, lb3, ub3, dimension, iteration, csi=1, psi=1,
                 alpha0=1, alpha1=0.1, norm0=0, norm1=0.1):
        """
        :param n: number of agents
        :param function: test function
        :param lb1: lower limits for plot axes
        :param ub1: upper limits for plot axes
        :param lb2: lower limits for plot axes
        :param ub2: upper limits for plot axes
        :param lb3: lower limits for plot axes
        :param ub3: upper limits for plot axes
        ...
        ELH_power_start = np.random.uniform(lb3, ub3, n)

        pre_prep_agents = []
        for count in range (0, n):
            pre_prep_agents.append([ESS_capacity_start[count], ESS_power_start[count], ELH_power_start[count]])
        ...
        for t in range(iteration):
            ...
            for count1, agent in enumerate (self.__agents):
                for count2, unit in enumerate(agent):
                    ...
                    if count2 == 2:
                        self.__agents[count1][count2] = np.clip(unit, lb3, ub3)

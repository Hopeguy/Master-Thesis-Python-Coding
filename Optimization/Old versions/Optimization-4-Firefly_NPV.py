...
n = 5 #number of agents (fireflies) Comparable to number of solution 
fitness_function = fitness_func_NPV       #fitness function to be used
lb1, ub1= 0.1, 8000 
lb2, ub2 = 0.1, np.max(Energy_hourly_use)  #lower bound of search space
dimensions = 2 #search space dimension (for this case 2, one for ESS capcity and one for ESS power)
...
df.to_csv(r'Results\Firefly_case_2_ESS_NPV\ESS_power_NPV_etc\Firefly_case_ESS_5_gen.csv', index=False, )
tf.to_csv(r'Results\Firefly_case_2_ESS_NPV\Charge_discharge_capacity\Firefly_case_ESS_5_gen_Sch_year_10.csv', index=False, )
